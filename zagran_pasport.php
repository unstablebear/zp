...
<script type="text/javascript" src="{$config['http_home_url']}engine/js/jquery-1.3.2.js"></script>
<script type="text/javascript" src="{$config['http_home_url']}engine/js/date.js"></script>
<script type="text/javascript" src="{$config['http_home_url']}engine/js/jquery.datePicker-2.1.2.js"></script>

<script type="text/javascript" src="{$config['http_home_url']}engine/js/jquery_ui/ui/ui.core.js"></script> 
<!--script type="text/javascript" src="{$config['http_home_url']}engine/js/jquery_ui/ui/ui.draggable.js"></script-->
<!--script type="text/javascript" src="{$config['http_home_url']}engine/js/jquery_ui/ui/ui.resizable.js"></script-->
<script type="text/javascript" src="{$config['http_home_url']}engine/js/jquery_ui/ui/ui.dialog.js"></script>
<script type="text/javascript" src="{$config['http_home_url']}engine/js/jquery_ui/ui/effects.core.js"></script>
